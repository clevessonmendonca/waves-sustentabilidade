...
export const CTASection = () => {
  return (
    <section className="mx-auto mt-32 max-w-7xl">
      <div className="relative flex w-full flex-col items-center justify-center overflow-hidden bg-gray-900 px-6 pb-80 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:flex-row md:pb-0 lg:gap-x-20 lg:px-24 md:pt-0">
        <svg
